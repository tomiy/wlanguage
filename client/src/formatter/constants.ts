...
let numberPattern = /0[xX][0123456789abcdefABCDEF_]*n?|0[oO][01234567_]*n?|0[bB][01_]*n?|\d[\d_]*n|(?:\.\d[\d_]*|\d[\d_]*\.?[\d_]*)(?:[eE][+-]?[\d_]+)?/;
...
export const PATTERN = {
    WHITESPACE: 'PT_WHITESPACE',
    IDENTIFIER: 'PT_IDENTIFIER',
    NUMBER: 'PT_NUMBER',
    PUNCT: 'PT_PUNCT',
    COMMENT: 'PT_COMMENT',
    BLOCK_COMMENT: 'PT_BLOCK_COMMENT',
    SINGLE_QUOTE: 'PT_SINGLE_QUOTE',
    DOUBLE_QUOTE: 'PT_DOUBLE_QUOTE'
}

export const REGEXP = {
    PUNCT: new RegExp(punct),
